...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-2 py-3 text-sm font-semibold", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default text-foreground/70 select-none items-center rounded-sm py-3 px-4 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&[data-state=checked]>span]:font-semibold  [&[data-state=checked]>span]:!text-foreground ",
      className
    )}
    {...props}
  >
